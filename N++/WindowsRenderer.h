...
public:
	...
	void drawBitmap(const Bitmap* bitmap, int x, int y, int width = -1, int height = -1, int srcX = 0, int srcY = 0);

	
	// Ritar en bitmapsbild
	void drawBitmapTransparent(const Bitmap* bitmap, int filterR, int filterG, int filterB, int x, int y, int width = -1, int height = -1, int srcX = 0, int srcY = 0, int srcWidth = -1, int srcHeight = -1);
